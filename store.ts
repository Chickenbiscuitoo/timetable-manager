...
interface TimetableState {
	...
	addSubject: (name: string, shortname: string, commitee: number) => void
	updateSubject: (
		id: number,
		name: string,
		shortname: string,
...
const useTimetableStore = create<TimetableState>((set, get) => ({
	...
	subjects: [
		{ id: 2, name: 'English', shortname: 'ENG', commitee: 2 },
		{ id: 3, name: 'History', shortname: 'HIS', commitee: 1 },
		{ id: 4, name: 'Geography', shortname: 'GEO', commitee: 1 },
		{ id: 5, name: 'Physics', shortname: 'PHY', commitee: 1 },
		{ id: 6, name: 'Spanish', shortname: 'SPA', commitee: 2 },
		{ id: 7, name: 'Chemistry', shortname: 'CHE', commitee: 1 },
		{ id: 8, name: 'Italian', shortname: 'ITA', commitee: 2 },
		{ id: 1, name: 'Math', shortname: 'MAT', commitee: 1 },
	],
	classes: [
	...
	addSubject: (name, shortname, commitee) => {
		const id = Date.now() + Math.random()
		set((state) => ({
			subjects: [
				...state.subjects,
				{ id, name, shortname, commitee },
			],
		}))
	},

	updateSubject: (id, name, shortname, commitee) => {
		set((state) => ({
			subjects: [
